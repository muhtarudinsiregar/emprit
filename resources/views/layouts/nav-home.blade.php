<nav class="bg-transparent py-4 px-4 lg:px-16 xl:py-8 fixed top-0 z-50 w-full md:px-8 xl:px-24 xxl:px-40" id="nav">
        ...
        <div class="w-full navigation-menu hidden md:flex md:w-3/4 relative">
            <div class="flex flex-col md:flex-row pt-8 pb-2 md:pt-0 md:pb-0 md:ml-auto md:items-center relative">
                ...
                <a class="font-bold text-white ml-4 mr-4 hover:underline">
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded uppercase">sign
                        in</button>
                </a>
            </div>
        </div>
